...
1. Направете нов цикъл, който итерира по read_rows. Принтирайте само този лист на екрана, чийто елемент за колона 'Origin' има 'Europe'. <br>
...
### 7. Направете нов цикъл, който итерира по read_rows. Принтирайте само този лист на екрана, чийто елемент за колона 'Origin' има 'Europe'. <br>
*Подсказка: Отворете файла cars.csv в някой редактор. Първия ред на файла е с имената на колоните. Проверете, коя колона е с името Origin. Бройте от 0 :)* 
```python
def read_file(name):
	f = open('cars.csv', 'r')
